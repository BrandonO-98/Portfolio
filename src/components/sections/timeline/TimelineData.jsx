const timelineData = [
  ...
  {
    id: 4,
    title: 'BioPhysics Researcher ',
    location: 'University of Toronto',
    desc: [`Used Molecular Dynamics software (Gromacs) via SSH to simulate
  ...
  {
    id: 7,
    title: 'Undergraduate Climate Physics Researcher',
    location: 'University of Toronto',
  ...
  {
    id: 8,
    title: 'Undergraduate BioPhysics Researcher',
    location: 'University of Toronto',
